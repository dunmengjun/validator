...
import com.dmj.validation.constraint.Positive.List;
import com.dmj.validation.validator.constraint.PositiveValidator;
...
public @interface Positive {
  ...
  String message() default "{com.dmj.validation.constraint.Positive}";
