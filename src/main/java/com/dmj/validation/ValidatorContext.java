...
public class ValidatorContext {
  ...
  public <T> boolean valid(String name, ConstraintValidator<T, Annotation> validator) {
    ...
    if (selfValidator instanceof FieldValidator) {
      ...
      boolean valid = validator.valid((T) fieldValidator.getValue(), null);
  ...
  public <T, R> boolean valid(FieldLambda<T, R> fieldLambda,
      ConstraintValidator<R, Annotation> validator) {
