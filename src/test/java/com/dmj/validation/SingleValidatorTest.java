...
public class SingleValidatorTest {
  ...
  static Stream<Arguments> errorGenerator() {
    return Stream.of(
        Arguments.of(new SingleBean(), NotNull.class, "name",
            "{com.dmj.validation.constraint.NotNull}"),
        Arguments.of(new SingleBean(), NotBlank.class, "name",
            "{com.dmj.validation.constraint.NotBlank}"),
        Arguments.of(new SingleBean(), NotEmpty.class, "name",
            "{com.dmj.validation.constraint.NotEmpty}"),
        Arguments.of(new SingleBean("a"), Size.class, "name",
            "{com.dmj.validation.constraint.Size}"),
        Arguments.of(new SingleBean("a"), Pattern.class, "name",
            "{com.dmj.validation.constraint.Pattern}"),
        Arguments.of(new SingleBean("a"), Email.class, "name",
            "{com.dmj.validation.constraint.Email}"),
        Arguments.of(new SingleBean("123"), Digits.class, "name",
            "{com.dmj.validation.constraint.Digits}"),
        Arguments.of(new SingleBean(false), AssertTrue.class, "flag",
            "{com.dmj.validation.constraint.AssertTrue}"),
        Arguments.of(new SingleBean(true), AssertFalse.class, "flag",
            "{com.dmj.validation.constraint.AssertFalse}"),
        Arguments.of(new SingleBean(-1), Positive.class, "ints",
            "{com.dmj.validation.constraint.Positive}"),
        Arguments.of(new SingleBean(0), Positive.class, "ints",
            "{com.dmj.validation.constraint.Positive}"),
        Arguments.of(new SingleBean(-1), PositiveOrZero.class, "ints",
            "{com.dmj.validation.constraint.PositiveOrZero}"),
        Arguments.of(new SingleBean(1), Negative.class, "ints",
            "{com.dmj.validation.constraint.Negative}"),
        Arguments.of(new SingleBean(0), Negative.class, "ints",
            "{com.dmj.validation.constraint.Negative}"),
        Arguments.of(new SingleBean(1), NegativeOrZero.class, "ints",
            "{com.dmj.validation.constraint.NegativeOrZero}"),
        Arguments.of(new SingleBean(99), Min.class, "ints",
            "{com.dmj.validation.constraint.Min}"),
        Arguments.of(new SingleBean(201), Max.class, "ints",
            "{com.dmj.validation.constraint.Max}"),
        Arguments.of(new SingleBean(0.32), DecimalMin.class, "decimal",
            "{com.dmj.validation.constraint.DecimalMin}"),
        Arguments.of(new SingleBean(11.32), DecimalMax.class, "decimal",
            "{com.dmj.validation.constraint.DecimalMax}")
    );
  }
}
